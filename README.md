...
| **v2.2** | 01-11-2024 | IDBlock | Para esta versión, hemos desarrollado la Landing Page y una versión inicial de nuestra Aplicación Móvil. También, realizamos el primer sprint junto al despliegue de la Landing Page y la Aplicación Móvil. |
...
- [Capítulo VII: Product Implementation, Validation & Deployment](/chapter06.md#capítulo-v-solution-uiux-design)
  ...
  - [7.2. Solution Implementation](/chapter06.md#52-information-architecture)
    ...
    - [7.2.2. Sprint 2](/chapter06.md#521-organization-systems)
        - [7.2.2.1. Sprint Planning 2](/chapter05.md#42561-bounded-context-domain-layer-class-diagrams)   
        - [7.2.2.2. Sprint Backlog 2](/chapter05.md#42561-bounded-context-domain-layer-class-diagrams)
        - [7.2.2.3. Development Evidence for Sprint Review](/chapter05.md#42561-bounded-context-domain-layer-class-diagrams)
        - [7.2.2.4. Testing Suite Evidence for Sprint Review](/chapter05.md#42561-bounded-context-domain-layer-class-diagrams)
        - [7.2.2.5. Execution Evidence for Sprint Review](/chapter05.md#42561-bounded-context-domain-layer-class-diagrams)
        - [7.2.2.6. Services Documentation Evidence for Sprint Review](/chapter05.md#42561-bounded-context-domain-layer-class-diagrams)
        - [7.2.2.7. Software Deployment Evidence for Sprint Review](/chapter05.md#42561-bounded-context-domain-layer-class-diagrams)
        - [7.2.2.8. Team Collaboration Insights during Sprint](/chapter05.md#42561-bounded-context-domain-layer-class-diagrams)     
